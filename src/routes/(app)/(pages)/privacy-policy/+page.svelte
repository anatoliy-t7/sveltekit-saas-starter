...
<svelte:head>
	<title>Privacy Policy - {PUBLIC_APP_NAME}</title>
</svelte:head>
		...
		<ul>
			...
			<li>
				<p>
					...
					or &quot;Our&quot; in this Agreement) refers to MyOrganic, Pyrenees, France.
				</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p>
					<strong>Website</strong> refers to MyOrganic, accessible from
					<a href="https://www.myorganic.com" rel="external nofollow noopener" target="_blank"
						>https://www.myorganic.com</a
					>
				</p>
			</li>
			<li>
		...
		<ul>
			<li>
				By visiting this page on our website: <a
					href="https://myorganic.com/contact"
					rel="external nofollow noopener"
					target="_blank">https://myorganic.com/contact</a
				>
			</li>
		</ul>
	</div>
